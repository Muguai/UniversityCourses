...
public class HashTableTest {
	...
	public void testClustering(ProbingHashTable<HashItem> sut, String expected) {
		...
		// Ta bort kommentaren om du vill se hur datat fÃķrdelar sig
		System.out.println(sut);

		// Enkelt men klumpigt och vÃĪldigt kÃĪnsligt sÃĪtt att kontrollera att saker
		// hamnar pÃĨ rÃĪtt stÃĪlle
