...
void setup(){
  ...
  // Add all tanks to nodes on the grid.
  grid.getNearestNode(new PVector(500, 500)).addContent(allTrees[2]);
  grid.getNearestNode(new PVector(550, 500)).addContent(allTrees[2]);
  grid.getNearestNode(new PVector(500, 550)).addContent(allTrees[2]);
  grid.getNearestNode(new PVector(550, 550)).addContent(allTrees[0]);
  grid.getNearestNode(new PVector(200, 550)).addContent(allTrees[0]);
  grid.getNearestNode(new PVector(200, 600)).addContent(allTrees[0]);
  grid.getNearestNode(new PVector(200, 650)).addContent(allTrees[0]);
  grid.getNearestNode(new PVector(250, 550)).addContent(allTrees[0]);
  grid.getNearestNode(new PVector(250, 600)).addContent(allTrees[0]);
  grid.getNearestNode(new PVector(250, 650)).addContent(allTrees[0]);
  grid.getNearestNode(new PVector(250, 200)).addContent(allTrees[1]);
  grid.getNearestNode(new PVector(250, 250)).addContent(allTrees[1]);
  grid.getNearestNode(new PVector(300, 200)).addContent(allTrees[1]);
  grid.getNearestNode(new PVector(300, 250)).addContent(allTrees[1]);
