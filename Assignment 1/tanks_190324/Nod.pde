...
public class Nod<S, A> {
  ...
  /**
     ...
     */
    public Nod(S state, Nod parent, A action, float pathCost) {
        this.state = state;
        this.parent = parent;
        this.action = action;
    ...
    public Nod childNode(Problem problem, A action) {
        ...
        Nod<S, A> nextNode = new Nod(nextState, this, action, problem.getPathCost(this.getPathCost(), getState(), action, nextState));
        return nextNode;
    }
